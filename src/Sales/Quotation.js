                        ...
                        <th className="p-1 flex items-center justify-start  h-full">
                            ...
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <div className='font-semibold text-sm text-neutral-900 font-Manrope'>Quotation ID</div>
                                </div>
                            </th>
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <div className='font-semibold text-sm text-neutral-900 font-Manrope'>Quotation Date</div>
                                </div>
                            </th>
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <div className='font-semibold text-sm text-neutral-900 font-Manrope'>Expiration Date</div>
                                </div>
                            </th>
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <div className='font-semibold text-sm text-neutral-900 font-Manrope'>Shipping Cost</div>
                                </div>
                            </th>
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <div className='font-semibold text-sm text-neutral-900 font-Manrope'>No of Product</div>
                                </div>
                            </th>
                            <th className="p-1 font-semibold text-base text-neutral-900">
                                <div className="flex items-center justify-start gap-2">
                    ...
                    <tbody>
                        {currentItems.map((item, index) => (
                            <tr key={index} className="hover:bg-gray-50 border-0">
                                ...
                                <td className="p-2 font-semibold text-sm font-Manrope text-neutral-900">{item.quantity}</td>
                                <td className="p-2 font-semibold text-sm font-Manrope text-neutral-900">{item.total}</td>
